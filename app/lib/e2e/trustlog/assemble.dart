...
/// Splits a marshalled chain into individually marshalled entries without
/// re-encoding. Mirrors Go's ChainEntries.
...
/// Groups marshalled entries into genesis-rooted chains encoded identically to Go's
/// MarshalChain. A branch whose head cannot walk Prev back to a nil-Prev genesis is
/// skipped — a chain with a hole cannot be verified.
///
/// Raw entry bytes are used as-is (never re-encoded), so chain bytes are byte-identical
/// to what the gateway sent. The reported count is input entries not placed into any
/// complete chain.
