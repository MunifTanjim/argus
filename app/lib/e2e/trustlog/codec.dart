...
/// Canonical co-sign order matching Go trustlog.canonicalCoSigns. Co-sign order is
/// committed by nothing, so a gateway could otherwise reorder them to make the client
/// compute a different Tip than the node. Returns a sorted copy; input not mutated.
...
/// Chain hash of a full signed entry. For KindRevokeSigner, replaces is already in
/// sigBytes; CoSigns are appended after Sig in canonical order so the chain commits
/// to the full co-signed payload regardless of co-sign order. Mirrors Go hashEntry.
