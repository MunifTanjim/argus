...
func newRootCmd(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:           "argus",
		Short:         "Oversee and control your AI coding tools from one place",
		Version:       version,
	...
	cmd.AddCommand(newStartCmd(version), newHooksCmd(), newHookCmd(), newPingCmd(), newPairCmd(), newUnpairCmd())
