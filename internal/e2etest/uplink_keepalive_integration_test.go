...
// Regression: the gateway heartbeats node uplinks, and the node's cleartext uplink
// dispatch serves only node.identify. When ping was refused by that dispatch, the
