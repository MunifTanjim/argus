...
func NewInProcessSource(id, label, version, identityPubKey, signerPubKey string, caps api.NodeCapabilities, reg *registry.Registry, dispatch api.DispatchFunc) *InProcessSource {
	return &InProcessSource{id: id, label: label, version: version, identityPubKey: identityPubKey, signerPubKey: signerPubKey, caps: caps, reg: reg, dispatch: dispatch, done: make(chan struct{})}
}
