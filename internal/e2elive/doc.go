...
// bind-mounted under a single scoped temp root — to exercise the end-to-end
// encryption path against real processes. The heavyweight tests build a docker
// image and bind a loopback port; run go test -short to skip them.
//
