...
// writeTask writes a minimal task JSON into dir/<id>.json.
...
// setup points claudeHome at a temp dir and returns the session-<short> task dir
// for a synthetic transcript path whose UUID short segment is "abcd1234".
