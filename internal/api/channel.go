...
// NewPlainChannel creates a plaintext channel using the identity cipher.
...
// ParseRelayFrame parses a raw newline-delimited frame line into a RelayFrame.
// It mirrors the construction in Peer's read loop.
