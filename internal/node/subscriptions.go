...
// transcript, or a subagent file when AgentID is set. It also returns the adapter
// owning the session so the caller can fold with the right parser.
